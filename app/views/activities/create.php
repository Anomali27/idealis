...
<div class="page-header">
    <div class="container">
        ...
        <p>Create a new social activity for PIC students</p>
    </div>
</div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-input" required
                           placeholder="e.g., Bakti Sosial Lingkungan">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="requirements" name="requirements" class="form-input" rows="3"
                              placeholder="What do volunteers need to bring or prepare?"></textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="location" name="location" class="form-input" required
                           placeholder="e.g., Area Sekolah, Masjid PIC">
                </div>
