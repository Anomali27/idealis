...
<section class="pt-28 pb-16 bg-gray-50 min-h-screen font-poppins">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <a href="/admin/dashboard?tab=users"
        ...
        <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl">
            <form action="/admin/store" method="POST" class="space-y-6">
                ...
                <div id="student-fields"
                    ...
                    <div>
                        <label for="nis" class="block text-xs font-bold text-gray-600 uppercase mb-2">NIS (Student
                            Number)</label>
                        <input type="text" name="nis" id="nis" placeholder="e.g. 1234"
                    ...
                    <div>
                        <label for="class" class="block text-xs font-bold text-gray-600 uppercase mb-2">Class
                            Details</label>
                        <input type="text" name="class" id="class" placeholder="e.g. Class 10-A"
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 bg-white outline-none transition-all text-gray-900 font-medium">
                    </div>
                    <div>
                        <label for="major" class="block text-xs font-bold text-gray-600 uppercase mb-2">Major /
                            Department</label>
                        <input type="text" name="major" id="major" placeholder="e.g. TKJ"
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 bg-white outline-none transition-all text-gray-900 font-medium">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Account Status -->
                    <div>
                        <label for="is_active" class="block text-sm font-semibold text-gray-700 mb-2">Account Status
                            *</label>
                ...
                <div class="flex gap-4 pt-4 border-t border-slate-100">
                    <button type="submit"
                        class="flex-grow py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-emerald-600/20 flex items-center justify-center gap-2 cursor-pointer">
                    ...
                    <a href="/admin/dashboard?tab=users"
                        class="px-8 py-3.5 bg-white text-gray-700 border border-gray-200 font-semibold rounded-xl hover:bg-gray-50 transition-all text-center">
                        Cancel
                    </a>
                </div>
            </form>
